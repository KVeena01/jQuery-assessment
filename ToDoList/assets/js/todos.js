...
window.onload = function(){
    ...
    window.localStorage.setItem('items', JSON.stringify(givendata));
    }
    else{
        givendata = JSON.parse(window.localStorage.getItem('items'));  
    }
    $.each(givendata,function(key,obj){
        $("ul").append("<li><span><i class='fas fa-trash'></i> </span>"+ obj.name + "   " + obj.date+"   "+ obj.assigned+"</li>");
